...
@Path("law_articles")
public class LawArticleService extends RestProvider {
    ...
    public Response getViewPage() {
        ...
        try {
            ...
            ViewPage<LawArticle> vp = dao.findViewPage(sortParams, params.getPage(), pageSize);
            ...
            outcome.setTitle("law_articles");
            outcome.addPayload("contentTitle", "law_articles");
    ...
    public Response getById(@PathParam("id") String id) {
        try {
            ...
            outcome.addPayload("contentTitle", "law_article");
    ...
    public Response add(LawArticle dto) {
        dto.setId(null);
        return save(dto);
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Response update(@PathParam("id") String id, LawArticle dto) {
        dto.setId(UUID.fromString(id));
        return save(dto);
    }

    public Response save(LawArticle dto) {
        _Session session = getSession();
        IUser<Long> user = session.getUser();
    ...
    private void validate(LawArticle entity) throws DTOException {
