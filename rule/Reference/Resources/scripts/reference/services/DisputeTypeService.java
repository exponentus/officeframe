...
public class DisputeTypeService extends RestProvider {
    ...
    public Response getViewPage() {
        ...
        try {
            ...
            outcome.addPayload("contentTitle", "dispute_types");
    ...
    public Response getById(@PathParam("id") String id) {
        try {
            ...
            outcome.addPayload("contentTitle", "dispute_type");
    ...
    public Response delete(@PathParam("id") String id) {
        try {
            ...
            DisputeType entity = dao.findByIdentefier(id);
            if (entity != null) {
                dao.delete(entity);
            }
    ...
    private void validate(DisputeType entity) throws DTOException {
