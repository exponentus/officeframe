...
import reference.domain.IndustryTypeCategoryDomain;
...
public class IndustryTypeCategoryService extends ReferenceService<IndustryTypeCategory, IndustryTypeCategoryDomain> {
	...
	@Override
	public Response saveForm(IndustryTypeCategory dto) {
		try {
			IndustryTypeCategoryDomain domain = new IndustryTypeCategoryDomain(getSession());
			IndustryTypeCategory entity = domain.fillFromDto(dto, new Validation(), getWebFormData().getFormSesId());
	...
	public class Validation implements IValidation<IndustryTypeCategory> {

		@Override
		public void check(IndustryTypeCategory dto) throws DTOException {
