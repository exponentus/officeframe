...
public class DefendantTypeService extends RestProvider {
    ...
    public Response getViewPage() {
        ...
        try {
            ...
            outcome.addPayload("contentTitle", "defendant_types");
    ...
    public Response getById(@PathParam("id") String id) {
        try {
            ...
            outcome.addPayload("contentTitle", "defendant_type");
    ...
    private void validate(DefendantType entity) throws DTOException {
