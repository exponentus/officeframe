...
@Path("kuf")
public class KufService extends RestProvider {
    ...
    public Response getViewPage() {
        ...
        try {
            ...
            ViewPage<Kuf> vp = dao.findViewPage(sortParams, params.getPage(), pageSize);
            ...
            outcome.setTitle("kuf");
            outcome.addPayload("contentTitle", "kuf");
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Response update(@PathParam("id") String id, Kuf dto) {
        dto.setId(UUID.fromString(id));
        return save(dto);
    }

    public Response save(Kuf dto) {
        _Session session = getSession();
        IUser<Long> user = session.getUser();
    ...
    private void validate(Kuf entity) throws DTOException {
