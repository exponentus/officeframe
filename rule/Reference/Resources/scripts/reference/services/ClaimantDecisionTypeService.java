...
@Path("claimant_decision_types")
public class ClaimantDecisionTypeService extends RestProvider {
    ...
    public Response getViewPage() {
        ...
        try {
            ...
            ViewPage<ClaimantDecisionType> vp = dao.findViewPage(sortParams, params.getPage(), pageSize);
            ...
            outcome.setTitle("claimant_decision_types");
            outcome.addPayload("contentTitle", "claimant_decision_types");
    ...
    public Response getById(@PathParam("id") String id) {
        try {
            ...
            outcome.addPayload("contentTitle", "claimant_decision_type");
    ...
    public Response add(ClaimantDecisionType dto) {
        dto.setId(null);
        return save(dto);
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Response update(@PathParam("id") String id, ClaimantDecisionType dto) {
        dto.setId(UUID.fromString(id));
        return save(dto);
    }

    public Response save(ClaimantDecisionType dto) {
        _Session session = getSession();
        IUser<Long> user = session.getUser();
    ...
    private void validate(ClaimantDecisionType entity) throws DTOException {
