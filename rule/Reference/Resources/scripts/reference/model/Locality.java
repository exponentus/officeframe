...
public class Locality extends SimpleReferenceEntity {
	...
	public String getFullXMLChunk(_Session ses) {
		...
		chunk.append("<localitytype id=\"" + type.getId() + "\">" + type.getLocalizedName(ses.getLang())
				+ "</localitytype>");
		chunk.append("<region id=\"" + region.getId() + "\">" + region.getLocalizedName(ses.getLang()) + "</region>");
		if (district != null) {
			chunk.append("<district id=\"" + district.getId() + "\">" + district.getLocalizedName(ses.getLang())
					+ "</district>");
		}
