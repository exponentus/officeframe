...
public class MainNavigator extends _DoPage {
	...
	public void doGET(_Session session, _WebFormData formData) {
		...
		_OutlineEntry primaryOrgEntry = new _OutlineEntry(getLocalizedWord("primary_organization", lang), "primaryorg-view");
		...
		if (primaryOrg != null) {
			primaryOrgEntry.addEntry(new _OutlineEntry(primaryOrg.getLocalizedName(lang),
			        getLocalizedWord("primary_organization", lang) + " : " + primaryOrg.getLocalizedName(lang), "structure-view",
			        "p?id=structure-view"));
		}
