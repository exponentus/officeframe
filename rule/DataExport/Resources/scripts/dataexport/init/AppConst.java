...
public class AppConst extends DefaultAppConst {
    ...
    public static String NAME_FRA = "Exportation de données";
    public static String NAME_RUS = "Экспорт данных";
    public static String NAME_KAZ = "Экспорт данных";
    public static String NAME_POR = "Exportação de dados";
    public static String NAME_SPA = "Exportación de Datos";
