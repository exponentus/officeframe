...
public class MainNavigator extends _DoPage {
	...
	public void doGET(_Session session, WebFormData formData) {
		...
		Outline outline = new Outline(getLocalizedWord("services", lang), "services");
		outline.addEntry(new OutlineEntry(getLocalizedWord("export_profiles", lang), "exportprofile-view"));
