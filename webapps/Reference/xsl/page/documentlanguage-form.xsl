...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="_content">
        <xsl:apply-templates select="//document[@entity = 'documentlanguage']"/>
    </xsl:template>
        ...
        <form name="{@entity}" action="" data-edit="{@editable}">
            <header class="content-header">
                <h1 class="header-title">
                    <xsl:value-of select="//captions/doc_languages/@caption"/>
                </h1>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select name="code" class="span2">
                                <xsl:apply-templates
                                        select="//constants[@entity = 'languagecode']/entry[@attrval != 'UNKNOWN']"
                                        mode="select_options">
